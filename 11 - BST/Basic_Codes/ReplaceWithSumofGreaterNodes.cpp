...
vector<BinaryTreeNode<int> *> getNodes(BinaryTreeNode<int> *root)
{
    if (root == NULL)
    {
    ...
    vector<BinaryTreeNode<int> *> LeftVector = getNodes(root->left);
    LeftVector.push_back(root);
    vector<BinaryTreeNode<int> *> RightVector = getNodes(root->right);
    LeftVector.insert(LeftVector.end(), RightVector.begin(), RightVector.end()); //Imp line

    return LeftVector;
}
void replaceWithLargerNodesSum(BinaryTreeNode<int> *root)
{
    vector<BinaryTreeNode<int> *> arr = getNodes(root);
